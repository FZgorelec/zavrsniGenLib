...
public class MovementTreeFactory implements ITreeFactory, IGenotypeFactory<ITree> {
    ...
    public MovementTreeFactory(int maxDepth,
        ...
        this.nonTerminatingValues = new String[]{ProgramInstructions.IF_FOOD_AHEAD.toString(),ProgramInstructions.PROG2.toString(),ProgramInstructions.PROG3.toString()};
    ...
    private boolean isBinary(String value) {
        if (value.equals(ProgramInstructions.PROG2.toString()) || value.equals(ProgramInstructions.IF_FOOD_AHEAD.toString()))
            return true;
        return false;
    }
